...
import { ArrowRight, Users, BookOpen, Calendar, Star, Globe, Shield, User, LogOut } from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <Card className="p-6 hover:shadow-lg transition-shadow">
                ...
                <h3 className="font-semibold mb-2">Find Skill Partners</h3>
                <p className="text-gray-600 text-sm">Discover people who want to learn your skills</p>
              </Card>
              <Card className="p-6 hover:shadow-lg transition-shadow">
                <BookOpen className="h-8 w-8 text-green-600 mx-auto mb-4" />
                <h3 className="font-semibold mb-2">Learn New Skills</h3>
                <p className="text-gray-600 text-sm">Browse available skills and start learning</p>
              </Card>
              <Card className="p-6 hover:shadow-lg transition-shadow">
                <Calendar className="h-8 w-8 text-purple-600 mx-auto mb-4" />
                <h3 className="font-semibold mb-2">Schedule Sessions</h3>
                <p className="text-gray-600 text-sm">Manage your skill exchange sessions</p>
              </Card>
            </div>
          </div>
        </section>
